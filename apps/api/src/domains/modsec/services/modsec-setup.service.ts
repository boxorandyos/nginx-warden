...
`;
      ...
      for (const line of lines) {
        ...
        if (line.trim() === '# CRS Rule Disables (managed by Nginx Warden)') {
...
This directory contains rule disable configurations managed by Nginx Warden.
