...
describe('AuthService', () => {
  ...
  describe('login', () => {
    it('should successfully login user without 2FA', async () => {
      ...
      vi.spyOn(jwtUtil, 'generateRefreshToken').mockReturnValue({
  ...
  describe('logout', () => {
    it('should successfully logout user with refresh token', async () => {
      ...
      vi.spyOn(jwtUtil, 'verifyRefreshToken').mockReturnValue({
        userId,
        username: 'testuser',
        email: 'test@example.com',
        role: 'admin',
      ...
      vi.spyOn(authRepository, 'deleteUserSession').mockResolvedValue(undefined);
      vi.spyOn(authRepository, 'createActivityLog').mockResolvedValue(undefined);
      ...
      expect(authRepository.deleteUserSession).toHaveBeenCalledWith(userId, 'session-jti');
      expect(authRepository.createActivityLog).toHaveBeenCalledWith(
        userId,
        'User logged out',
        'logout',
  ...
  describe('refreshAccessToken', () => {
    it('should successfully refresh access token', async () => {
      ...
      vi.spyOn(authRepository, 'saveRefreshToken').mockResolvedValue(undefined);
      vi.spyOn(authRepository, 'revokeRefreshToken').mockResolvedValue(undefined);
      vi.spyOn(authRepository, 'touchUserSession').mockResolvedValue(undefined);
      ...
      expect(authRepository.touchUserSession).toHaveBeenCalledWith(mockUser.id, 'rotated-jti');
    });
