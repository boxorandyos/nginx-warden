# Nginx Warden documentation theme

This is a custom VitePress theme for the Nginx Warden documentation site, built on top of the default VitePress theme with enterprise-ready enhancements.
