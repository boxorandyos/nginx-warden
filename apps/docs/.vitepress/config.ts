...
export default defineConfig({
  title: 'Nginx Warden Documentation',
  description: 'Nginx Warden — manage nginx, ModSecurity, and the full proxy stack',
  lang: 'en-US',
  ...
  head: [
    ...
    ['meta', { name: 'author', content: 'Nginx Warden' }],
    ['meta', { property: 'og:title', content: 'Nginx Warden Documentation' }],
    ['meta', { property: 'og:description', content: 'Nginx Warden — manage nginx, ModSecurity, and the full proxy stack' }],
    ['meta', { property: 'og:type', content: 'website' }],
    ['meta', { property: 'og:image', content: '/og-image.png' }],
    ['meta', { name: 'twitter:card', content: 'summary_large_image' }],
    ['meta', { name: 'twitter:title', content: 'Nginx Warden Documentation' }],
    ['meta', { name: 'twitter:description', content: 'Nginx Warden — manage nginx, ModSecurity, and the full proxy stack' }],
  ...
  themeConfig: {
    ...
    footer: {
      ...
      copyright: `Copyright © 2025-${new Date().getFullYear()} Nginx Warden`
    },
