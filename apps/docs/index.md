...
hero:
  name: Nginx Warden
  text: Nginx & ModSecurity control plane
  tagline: Manage nginx, ModSecurity, SSL, domains, and monitoring from one place
  actions:
    - theme: brand
      text: Get Started
...
To get started with Nginx Warden, follow our [installation guide](/guide/installation) and check out the [quick start tutorial](/guide/quick-start).

## Documentation

- [Guide](/guide/introduction) - Learn how to use Nginx Warden
